...
!function(t) {
    ...
    INSPIRO.core= {
        ...
        pageLoader:function() {
            ...
            if(!e.hasClass("no-page-loader")) {
                var a=e.attr("data-animation-in")||"fadeIn", i=e.attr("data-animation-out")||"fadeOut", n=e.attr("data-icon")||10, s=e.attr("data-icon-color")||null, o=e.attr("data-speed-in")||1500, r=e.attr("data-speed-out")||800, l="", d="";
                switch(Number(n)) {
                    case 1:d='<div class="material-icon"><div class="spinner"><div class="right-side"><div class="bar"></div></div><div class="left-side"><div class="bar"></div></div></div></div>', l=".spinner .bar {border-color: "+s+";} .spinner .bar:after {background: "+s+";}";
                    break;
                    case 2:d='<div class="loader-inner ball-grid-pulse"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>', l=".ball-grid-pulse > div {background: "+s+"!important;}";
                    break;
                    case 3:d='<div class="loader01"></div>', l=".loader01 {border-color: "+s+" transparent "+s+" "+s+";} .loader01::after {background: "+s+";}";
                    break;
                    case 4:d='<div class="loader-inner square-spin"><div></div></div>', l=".square-spin > div {background: "+s+" !important;}";
                    break;
                    case 5:d='<div class="loader04"></div>', l=".loader04:after {background: "+s+" !important;}";
                    break;
                    case 6:d='<div class="loader-inner ball-rotate"><div></div></div>', l=".ball-rotate > div, .ball-rotate > div:after, .ball-rotate > div:before {background: "+s+" !important;}";
                    break;
                    case 7:d='<div class="loader-inner cube-transition"><div></div><div></div></div>', l=".cube-transition > div {background: "+s+" !important;}";
                    break;
                    case 8:d='<div class="loader-inner ball-zig-zag"><div></div><div></div></div>', l=".ball-zig-zag > div {background: "+s+" !important;}";
                    break;
                    case 9:d='<div class="loader-inner ball-triangle-path"><div></div><div></div><div></div></div>', l=".ball-triangle-path > div {background: "+s+" !important;}";
                    break;
                    case 10:d='<div class="loader-inner line-scale"><div></div><div></div><div></div><div></div><div></div></div>', l=".line-scale > div {background: "+s+" !important;}";
                    break;
                    case 11:d='<div class="loader-inner ball-scale-multiple"><div></div><div></div><div></div></div>', l=".ball-scale-multiple > div {background: "+s+" !important;}";
                    break;
                    case 12:d='<div class="loader-inner ball-pulse-sync"><div></div><div></div><div></div></div>', l=".ball-pulse-sync > div {background: "+s+" !important;}";
                    break;
                    case 13:d='<div class="loader-inner ball-beat"><div></div><div></div><div></div></div>', l=".ball-beat > div {background: "+s+" !important;}";
                    break;
                    case 14:d='<div class="loader-inner line-scale-pulse-out-rapid"><div></div><div></div><div></div><div></div><div></div></div>', l=".line-scale-pulse-out-rapid > div {background: "+s+" !important;}";
                    break;
                    case 15:d='<div class="loader-inner ball-scale-ripple-multiple"><div></div><div></div><div></div></div>', l=".ball-scale-ripple-multiple > div {border-color: "+s+" !important;}";
                    break;
                    case 16:d='<div class="loader-inner ball-spin-fade-loader"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>', l=".ball-spin-fade-loader > div {background: "+s+" !important;}";
                    break;
                    case 17:d='<div class="loader-inner line-spin-fade-loader"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>', l=".line-spin-fade-loader > div {background: "+s+" !important;}";
                    break;
                    case 18: d='<div class="loader-inner pacman"><div></div><div></div><div></div><div></div><div></div></div>', l=".pacman > div:nth-child(3), .pacman > div:nth-child(4), .pacman > div:nth-child(5), .pacman > div:nth-child(6)  {background: "+s+" !important;} .pacman > div:first-of-type, .pacman > div:nth-child(2) {border-color: "+s+" transparent "+s+" "+s+"}";
                    break;
                    case 19:d='<div class="loader-inner ball-grid-beat"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>', l=".ball-grid-beat > div {background: "+s+" !important;}";
                    break;
                    case 20:d='<div class="single9"></div>', l=".single9:before {background-color: "+s+" !important;}";
                    break;
                    default:d='<div class="material-icon"><div class="spinner"><div class="right-side"><div class="bar"></div></div><div class="left-side"><div class="bar"></div></div></div></div>', l=".spinner .bar {border-color: "+s+";} .spinner .bar:after {background: "+s+";}"
                }
        ...
        customHeight:function() {
            var a=t("[data-height-xxs]"), i=t("[data-height-xs]"), n=t("[data-height-sm]"), s=t("[data-height-md]"), o=t("[data-height-lg]");
    ...
    INSPIRO.header= {
        ...
        mainMenu:function() {
            ...
            ):t("#mainMenu nav > ul > li.dropdown > a, .dropdown-submenu > a, .dropdown-submenu > span").on("click",
            function() {
                return t(this).parent("li").siblings().removeClass("hover-active"), t(this).parent("li").toggleClass("hover-active"), !1
            }
            ),
            ...
            e.is(".device-lg, .device-md")&&t(".dropdown:not(.mega-menu-item) ul ul").each(function(e,
            i) {
        ...
        pageMenu:function() {
            f.length>0&&f.each(function() {
                ...
                )):t("#menu-responsive-icon").on("click",
                function() {
                    f.toggleClass("page-menu-active"), f.toggleClass("items-visible")
                }
                )
        ...
        dotsMenu:function() {
            ...
            g.parents("li").removeClass("current"),
            p.find('a[href="#'+INSPIRO.header.currentSection()+'"]').parent("li").addClass("current"))
        }
        ,
    ...
    INSPIRO.slider= {
        ...
        sliderScreenSizeControl:function() {
            if(t(".inspiro-slider").length>0) {
                var i=r.height(), n=o.height(), s=a.height(), l=i+n, d=t("#slider").hasClass("slider-fullscreen"), c=t("#slider").hasClass("slider-fullscreen")?1: 1.28, u=r.hasClass("header-transparent")||r.hasClass("header-light-transparent")||r.hasClass("header-dark-transparent")||r.hasClass("header-colored-transparent")||r.hasClass("header-modern"), m=t(".inspiro-slider, .inspiro-slider .owl-stage-outer, .inspiro-slider .owl-stage, .inspiro-slider .slide"), p=t(".inspiro-slider").data("height"), g=t(".inspiro-slider").data("height-xs")||300;
        ...
        youTubeBgPlayer:function() {
            return t().mb_YTPlayer?void(X.length>0&&X.each(function() {
                ...
                g||e.find("#youtube-background-controls").addClass("video-is-playing"),
                e.on("YTPReady",
                function() {
    ...
    INSPIRO.widgets= {
        ...
        twitter:function() {
            ...
            ,
            2e3):(console.log("twitter: twittie plugin is missing."),
            !0)
        }
        ,
        flickr:function() {
        ...
        contactForm:function() {
                    ...
                    submitHandler: function(i) {
                        ...
                        n.html('<i class="fa fa-refresh fa-spin"></i> Sending...'), t(i).ajaxSubmit( {
                            success: function(o) {
                                ...
                                t(i).find(".g-recaptcha").children("div").length>0&&grecaptcha.reset(),
                                t(i)[0].reset(),
                                n.html(s)):(t.notify( {
            ...
            !0):(console.log("contactForm: ajaxSubmit plugin is missing."),
            !0):(console.log("contactForm: validate plugin is missing."),
            !0)
        }
        ,
        subscribeForm:function() {
            ...
            !0):(console.log("subscribeForm: ajaxSubmit plugin is missing."),
            !0):(console.log("subscribeForm: validate plugin is missing."),
            !0)
        }
    }
    ,
    ...
    ,
    a.on("resize",
    INSPIRO.documentOnResize.functions),
    ...
    ,
    t(document).ready(INSPIRO.documentReady.functions),
    INSPIRO.documentOnLoad= {
        functions: function() {}
    }
    ,
    t(window).on("load",
    INSPIRO.documentOnLoad.functions),
    ...
    ,
    a.on("scroll",
    INSPIRO.documentScroll.functions),
